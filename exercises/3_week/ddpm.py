...
class Diffusion:
    ...
    def p_mean_std(self, model, x_t, t):
        ...
        predicted_noise = model.forward(x_t, t)  # HINT: use model to predict noise
        mean = x_t - alpha * predicted_noise # HINT: calculate the mean of the distribution p(x_{t-1} | x_t). See Eq. 11 in the ddpm paper at page 4
        std = torch.sqrt(beta)
