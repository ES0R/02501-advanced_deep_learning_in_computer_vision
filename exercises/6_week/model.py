...
class UNet(nn.Module):
    def __init__(self, img_size=16, c_in=3, c_out=3, time_dim=256, device="cuda", channels=32, num_classes=None):
...
class Classifier(nn.Module):
    def __init__(self, img_size=16, c_in=3, labels=5, time_dim=256, device="cuda", channels=32):
        ...
        self.fc = nn.Linear(img_size * img_size * channels, labels)
