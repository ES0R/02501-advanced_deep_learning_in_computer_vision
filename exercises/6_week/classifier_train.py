...
def train(device='cpu', T=500, img_size=16, input_channels=3, channels=32, time_dim=256):
    ...
    for epoch in pbar:
        ...
        for images, labels in train_loader:
            ...
            t = torch.randint(0, T, (images.shape[0],), device=device)  # Generate random time steps for each image sampled between 1 and T
            noised_images, _ = diffusion.q_sample(images, t)
    ...
    pbar.set_postfix(Epoch_Loss=avg_loss)
